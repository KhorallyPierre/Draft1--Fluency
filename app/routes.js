module.exports = function(app, passport, db) {
  ...
  app.get('/pair/:language', /*isLoggedIn,*/ function(req, res) {
    ...
    db.collection('userProfile').find({language: req.params.language}).toArray((err, result) => {
  ...
  app.post('/signup', passport.authenticate('local-signup', {
    ...
    db.collection('userProfile').save({ email: req.body.email, userId: req.user._id, color: req.body.color}, (err, result) => {
      if (err) return console.log(err)
